...
Run time: 2026-05-11T14:07:12.037857+00:00
...
| Concurrency | TiKV readpool max threads | TiKV gp3 IOPS / throughput | Duration | QPS | Avg latency | P95 latency | TiKV cop wait avg | TiKV cop wait max |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 220 | 12 | 3000 / 125 MB/s | 10 min | 345.84 | 630.1 ms | 755.3 ms | 1,118.8 ms | 1,413.0 ms |
| 220 | 24 | 3000 / 125 MB/s | 10 min | 318.37 | 686.0 ms | 833.3 ms | 1,573.1 ms | 3,044.9 ms |
| 220 | 12 | 6000 / 250 MB/s | 6 min | 320.17 | 671.3 ms | 868.1 ms | 1,133.0 ms | 1,512.9 ms |
| 330 | 12 | 3000 / 125 MB/s | 10 min | 321.70 | 1,013.4 ms | 1,252.8 ms | 2,021.2 ms | 2,998.9 ms |
| 330 | 24 | 3000 / 125 MB/s | 10 min | 234.81 | 1,389.9 ms | 4,697.5 ms | 1,745.9 ms | 2,338.9 ms |
| 330 | 12 | 6000 / 250 MB/s | 6 min | 330.03 | 984.2 ms | 1,151.5 ms | 1,373.9 ms | 1,868.9 ms |

Summary: `readpool=24` did not improve throughput. TiKV gp3 `6000/250` helped the 330-worker run by reducing cop wait and slightly improving QPS/latency, but did not help the 220-worker run.

## TiKV gp3 6000/250 vs Baseline

Change: only the 3 active TiKV EBS gp3 volumes were changed from `3000 IOPS / 125 MB/s` to `6000 IOPS / 250 MB/s`. TiFlash volumes were not changed. TiKV `readpool.unified.max-thread-count` stayed at `12`.

Baseline rows are the previous `3000/125` weighted-cop run with 10-minute windows. New rows are the `6000/250` run with 6-minute windows.

| Concurrency | TiKV gp3 IOPS / throughput | QPS | QPS vs baseline | Avg latency | Avg vs baseline | TiKV cop wait avg | Cop wait vs baseline | TiKV cop wait max | TiKV waiting semaphore avg/max |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 220 | 3000 / 125 MB/s baseline | 345.84 | - | 630.1 ms | - | 1,118.8 ms | - | 1,413.0 ms | 3,044.4 / 4,542.0 |
| 220 | 6000 / 250 MB/s | 320.17 | -7.4% | 671.3 ms | +6.5% | 1,133.0 ms | +1.3% | 1,512.9 ms | 3,175.0 / 4,444.0 |
| 330 | 3000 / 125 MB/s baseline | 321.70 | - | 1,013.4 ms | - | 2,021.2 ms | - | 2,998.9 ms | 5,637.9 / 8,369.0 |
| 330 | 6000 / 250 MB/s | 330.03 | +2.6% | 984.2 ms | -2.9% | 1,373.9 ms | -32.0% | 1,868.9 ms | 3,641.0 / 6,737.0 |

Observation: the higher TiKV gp3 setting did not improve the 220-worker run, but it materially reduced cop wait at 330 workers and slightly improved 330-worker QPS/average latency. The effect looks concurrency-sensitive rather than a universal improvement.
...
| 8 | 16983.6ms | 32291.9ms | 6 | 10 | 108.6 | 16143 | 8304.9 | 42368 | 1.05x faster | ok |
...
| 14 | 28809.4ms | 45421.2ms | 1000 | 10 | 1000 | 90 | 85.3 | 148.7 | 320.10x faster | ok |
| 15 | 24650.8ms | 42060.9ms | 1000 | 10 | 1000 | 77.7 | 85 | 93.3 | 317.26x faster | ok |
...
| 19 | 39798.6ms | 60018.5ms | 500 | 10 | 1000 | 86.7 | 88 | 96.2 | 459.04x faster | ok |
| 20 | 17.8ms | 5900.3ms | 1 | 10 | 1 | 4.4 | 3.5 | 12.9 | 4.05x faster | ok |
| 21 | 23577.6ms | 30859.8ms | 1000 | 10 | 1000 | 1556 | 245.6 | 13389.4 | 15.15x faster | ok |
...
| 24 | 60085.2ms | 60085.2ms | 0 | 10 | 1000 | 1765 | 1183.8 | 7046.3 | 34.04x faster | ok |
...
|---:|---:|---:|---:|---:|---:|---:|---:|
| 220 | 22 | 360 | 120536 | 320.17 | 671.3 | 868.1 | 75660.0 |
| 330 | 22 | 360 | 122788 | 330.03 | 984.2 | 1151.5 | 89841.5 |
...
- Window: `2026-05-11T13:54:13.168560+00:00` to `2026-05-11T14:00:29.641478+00:00`
- Grafana time range: [http://a2e41aa49d08647d1b55ecd7b146bbf6-2611d84fa96ba26a.elb.us-east-2.amazonaws.com:3000?from=1778507653168&to=1778508029641](http://a2e41aa49d08647d1b55ecd7b146bbf6-2611d84fa96ba26a.elb.us-east-2.amazonaws.com:3000?from=1778507653168&to=1778508029641)
...
|---|---:|---:|---:|---:|---:|---:|---|
| tidb | 3 | 5.59 | 7.11 | 14.8% | 46.60 | 53.40 |  |
| tikv | 3 | 25.23 | 34.36 | 71.6% | 107.67 | 109.33 |  |
| tiflash | 6 | 74.58 | 85.87 | 89.4% | 82.45 | 112.39 | TiFlash proxy process CPU metric |

| Query | Successful ops | Source avg | Source max | Source rows avg | Run avg ms | vs source avg | P95 ms | Max ms | Run rows avg |
|---:|---:|---:|---:|---:|---:|---|---:|---:|---:|
| 2 | 1386 | 320.8ms | 14332.3ms | 234 | 1311.4 | 4.09x source | 1940.7 | 16200.6 | 600 |
| 4 | 382 | 11882.9ms | 34102.7ms | 1000 | 16453.9 | 1.38x source | 38240.1 | 47219.9 | 1000 |
| 5 | 324 | 29101.7ms | 60034.6ms | 65 | 19377.6 | 1.50x faster | 37399.4 | 53957.2 | 1000 |
| 6 | 2257 | 44.8ms | 927.9ms | 168 | 797.4 | 17.80x source | 1388.0 | 2466.6 | 50 |
| 7 | 22962 | 8.7ms | 487.0ms | 35 | 78.4 | 9.01x source | 157.6 | 431.4 | 35 |
| 8 | 221 | 16983.6ms | 32291.9ms | 6 | 28861.7 | 1.70x source | 53719.1 | 59495.1 | 88.2 |
| 9 | 21300 | 28.1ms | 10778.1ms | 8 | 67.6 | 2.41x source | 138.9 | 364.6 | 24 |
| 10 | 293 | 41204.1ms | 51112.0ms | 136 | 16260.3 | 2.53x faster | 27614.5 | 31589.1 | 961.7 |
| 11 | 1964 | 17.0ms | 228.7ms | 1 | 733.4 | 43.14x source | 1301.8 | 2066.2 | 1 |
| 13 | 11923 | 29.8ms | 6157.8ms | 175 | 120.7 | 4.05x source | 236.5 | 1810.7 | 175 |
| 14 | 222 | 28809.4ms | 45421.2ms | 1000 | 21638.9 | 1.33x faster | 52001.6 | 61687.2 | 1000 |
| 15 | 212 | 24650.8ms | 42060.9ms | 1000 | 22525.2 | 1.09x faster | 40681.5 | 62758.7 | 1000 |
| 16 | 216 | 47800.9ms | 60019.8ms | 500 | 22223.4 | 2.15x faster | 32708.3 | 40772.1 | 1000 |
| 17 | 364 | 29564.9ms | 37139.7ms | 0 | 13068.6 | 2.26x faster | 23873.3 | 27363.2 | 1000 |
| 18 | 31915 | 3.7ms | 325.7ms | 4 | 45.1 | 12.19x source | 100.4 | 256.2 | 5 |
| 19 | 195 | 39798.6ms | 60018.5ms | 500 | 24911.6 | 1.60x faster | 43782.3 | 47029.1 | 1000 |
| 20 | 21561 | 17.8ms | 5900.3ms | 1 | 66.8 | 3.75x source | 138.6 | 349.6 | 1 |
| 21 | 104 | 23577.6ms | 30859.8ms | 1000 | 46591.0 | 1.98x source | 68216.9 | 75660.0 | 1000 |
| 22 | 1897 | 25.9ms | 233.2ms | 20 | 758.8 | 29.30x source | 1346.2 | 2345.2 | 20 |
| 23 | 362 | 33550.1ms | 35378.6ms | 0 | 13049.0 | 2.57x faster | 22350.0 | 25776.7 | 953.5 |
| 24 | 281 | 60085.2ms | 60085.2ms | 0 | 17071.9 | 3.52x faster | 22643.9 | 26037.6 | 1000 |
| 25 | 195 | 59691.1ms | 59691.1ms | 1000 | 24594.3 | 2.43x faster | 35644.6 | 43841.9 | 1000 |

#### Concurrency 330

- Window: `2026-05-11T14:00:44.816700+00:00` to `2026-05-11T14:06:56.862186+00:00`
- Grafana time range: [http://a2e41aa49d08647d1b55ecd7b146bbf6-2611d84fa96ba26a.elb.us-east-2.amazonaws.com:3000?from=1778508044816&to=1778508416862](http://a2e41aa49d08647d1b55ecd7b146bbf6-2611d84fa96ba26a.elb.us-east-2.amazonaws.com:3000?from=1778508044816&to=1778508416862)
...
| Component | Replicas | CPU avg cores | CPU max cores | CPU max % capacity | Mem avg GiB | Mem max GiB | Note |
|---|---:|---:|---:|---:|---:|---:|---|
| tidb | 3 | 5.15 | 7.38 | 15.4% | 50.56 | 59.63 |  |
| tikv | 3 | 20.56 | 25.07 | 52.2% | 108.51 | 110.75 |  |
| tiflash | 6 | 79.35 | 87.07 | 90.7% | 107.71 | 144.81 | TiFlash proxy process CPU metric |

| Query | Successful ops | Source avg | Source max | Source rows avg | Run avg ms | vs source avg | P95 ms | Max ms | Run rows avg |
|---:|---:|---:|---:|---:|---:|---|---:|---:|---: